...
impl TreeEntry {
    ...
    pub fn from(data: &[u8]) -> Option<TreeEntry> {
        ...
        let mut path_tail = 0;
        let mut entries_tail = 0;
        let mut subtrees_tail = 0;
        ...
        let entries = str::from_utf8(&data[(path_tail+1)..entries_tail]).ok()?
                        .parse::<i32>().ok()?;
        let subtrees = str::from_utf8(&data[(entries_tail+1)..subtrees_tail]).ok()?
                    .parse::<usize>().ok()?;
        let hash = data[(subtrees_tail+1)..].to_vec();
        Some(TreeEntry {
            path: String::from(path),
            entries,
            subtrees,
...
mod tests {
    ...
    const INDEX: [u8; 2878] = [
        0x44, 0x49, 0x52, 0x43, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x20, 0x60, 0x70, 0x7f, 0x04,
        0x37, 0x3c, 0x98, 0xe7, 0x60, 0x70, 0x7f, 0x04, 0x37, 0x3c, 0x98, 0xe7, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x26, 0x46, 0x41, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x24, 0xf8, 0x72, 0xf6, 0x60, 0x70, 0x7f, 0x46, 0x24, 0xf8, 0x72, 0xf6, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x18, 0xb3, 0xb9, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x6e, 0x6f, 0x72, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x7a, 0xf1, 0x69,
        0x1c, 0x60, 0x17, 0xae, 0x60, 0x7a, 0xf1, 0x69, 0x1c, 0x60, 0x17, 0xae, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x18, 0xb4, 0x01, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x6c, 0x6f, 0x63, 0x6b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x7a, 0xf1, 0x68,
        0x37, 0xd3, 0xcf, 0xa9, 0x60, 0x7a, 0xf1, 0x68, 0x37, 0xd3, 0xcf, 0xa9, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x18, 0xb3, 0xba, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x32, 0xb1, 0x9d, 0xe6, 0x60, 0x75, 0x09, 0x28, 0x32, 0xb1, 0x9d, 0xe6, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x26, 0x40, 0xee, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        ,
        ...
        0x32, 0x14, 0x5d, 0x1c, 0x00, 0x00, 0x00, 0x6c, 0x03, 0x27, 0xbe, 0x6f, 0x00, 0x00, 0x81, 0xa4,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x3d, 0xa4, 0x50, 0x3c, 0x6a,
        ...
        ,
        ...
        ,
        ...
        0x02, 0x1e, 0x7b, 0xe4, 0x00, 0x00, 0x00, 0x6c, 0x03, 0x1a, 0x39, 0x1c, 0x00, 0x00, 0x81, 0xa4,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1c, 0x3b, 0xe9, 0x69, 0x84, 0x78,
        ...
        0x1d, 0x7d, 0x42, 0xfe, 0x60, 0x75, 0x78, 0x6f, 0x1d, 0x7d, 0x42, 0xfe, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x19, 0xb2, 0xbb, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x20, 0x7a, 0x08, 0xe4, 0x60, 0x75, 0xc7, 0x15, 0x20, 0x7a, 0x08, 0xe4, 0x00, 0x00, 0x00, 0x6c,
        0x03, 0x1a, 0x39, 0x1e, 0x00, 0x00, 0x81, 0xa4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        , 
    ];
    #[test]
    fn test_index_from() {
        let index = Index::from(&INDEX).unwrap();
        let entry_size = 32;
        assert_eq!(index.entries.len(), entry_size);
        assert_eq!(index.entries[0].name, ".dockerignore");
        assert_eq!(index.entries[11].name, "src/cmd/commit.rs");
